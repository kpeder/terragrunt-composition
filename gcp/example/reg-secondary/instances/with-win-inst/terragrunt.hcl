...
dependency "with_win_template" {
  config_path  = find_in_parent_folders(local.env.dependencies.with_win_template_dependency_path)
  mock_outputs = local.env.dependencies.with_win_template_mock_outputs
...
inputs = {
  ...
  instance_template   = dependency.with_win_template.outputs.self_link
