...
dependency "with_gpu_template" {
  config_path  = find_in_parent_folders(local.env.dependencies.with_gpu_template_dependency_path)
  mock_outputs = local.env.dependencies.with_gpu_template_mock_outputs
...
inputs = {
  ...
  instance_template = dependency.with_gpu_template.outputs.self_link
